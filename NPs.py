...
if __name__ == '__main__':
    ...
    parser.add_argument('--input1', type=str, help='BRDF for intepolation')
    parser.add_argument('--int_weight', type=float, help='intepolation weight')
    ...
    if args.mode == 'compress':
        ...
        brdf = util.decode_material(x_grid, NoL, NoV, z, decoder)
